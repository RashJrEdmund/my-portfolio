...
const ExperienceData: Experience[] = [
  {
    ...
    orgDescription: "A fin tech start up base in Kigali Rwanda, with a vision to make money transfer easy across a number of African countries",
    orgLink: "https://aftawallet.com",
    orgLogo: "/afta-wallet.png",
    achievements: [
  ...
  },
  {
    ...
    orgLink: "",
    orgDescription: "A freelance tech organization consisting of a few developers",
    orgLogo: "/azen-enterprise.png",
    achievements: [
      "Colaborated in building good user interfaces",
